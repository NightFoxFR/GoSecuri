        ...
        stage('Build Docker Image on Portainer') {
            ...
            script {
                ...
                withCredentials([usernamePassword(credentialsId: 'Github', usernameVariable: 'GITHUB_USERNAME', passwordVariable: 'GITHUB_PASSWORD')]) {
                    def repoURL = """
                    https://manage-portainer.sk4m.fr/api/endpoints/1/docker/build?t=GoSecuri:latest&remote=https://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@github.com/LoicBrison/GoSecuri.git&dockerfile=Dockerfile&nocache=true
